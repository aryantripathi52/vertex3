...
export default function DashboardNavbar() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full h-16 border-b border-white/5 bg-[#0a0a0f]/80 backdrop-blur-md px-8 flex items-center justify-between pointer-events-auto">
      {/* Search Bar */}
      <div className="relative w-full max-w-sm ml-auto mr-8 hidden md:block">
      ...
      <div className="flex items-center gap-4">
        {/* Notifications? (Pill/Badge could be added) */}
